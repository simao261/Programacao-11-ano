...
namespace Ficha_6
{
    internal class Program
    {
        static void Main(string[] args)
        {
                ...
                Funcionario funcionario = new Funcionario("Ana", 101, "Bibliotecária");

               
                emprestimo1.LivroEmprestado += funcionario.NotificarLivroEmprestado;
                emprestimo2.LivroEmprestado += funcionario.NotificarLivroEmprestado;
        ...
        public class Funcionario
        {
           ...
           {
                emprestimo.LivroEmprestado += NotificarLivroEmprestado;
                Console.WriteLine($"Funcionario: {Nome} registrou um novo empréstimo.");
           }
            ...
            public void NotificarLivroEmprestado(object sender, string titulolivro)
            {
                Console.WriteLine($"Notificação para o funcionário {Nome}: o livro \"{titulolivro}\" foi emprestado.");
            }
